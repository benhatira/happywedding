  ...
  Drupal.behaviors.better_exposed_filters_select_as_links = {
        attach: function (context) {
            ...
            $('.bef-select-as-links', context).once(function () {
                var $this = $(this);
                var $widgets = $this.parents('.views-exposed-widgets');
                // Hide the actual form elements from the user.
                $this.find('select').hide();
                var $options = $this.find('select option');
                $this.find('a').click(function (event) {
                  console.log('click' , $(this).text() , $(this).attr('href'));
                    // We have to prevent the page load triggered by the links.
                    event.preventDefault();
                    event.stopPropagation();
                    var text = $(this).text();
                    // De-select old select value.
                   ...
                   // Set the corresponding option inside the select element
                    ...
                    $this.find('.bef-new-value').val($options.filter(':selected').val());

                    // Submit the form.
                    console.log($widgets.find('.views-submit-button input'));
